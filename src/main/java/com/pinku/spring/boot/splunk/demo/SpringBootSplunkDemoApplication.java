package com.pinku.spring.boot.splunk.demo;

import com.pinku.spring.boot.splunk.demo.dto.Order;
import com.pinku.spring.boot.splunk.demo.service.OrderService;
import com.pinku.spring.boot.splunk.demo.util.Mapper;
...
public class SpringBootSplunkDemoApplication {

	Logger logger = LogManager.getLogger(SpringBootSplunkDemoApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringBootSplunkDemoApplication.class, args);
	}
